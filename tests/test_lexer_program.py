...
class TestProgram(LexerTestBase):
    def test_whitespace_and_singleline_comments(self):
        ...
        self.thenReturnLexerOutput([
            ...
            LexerOutput(1, 4, Symbol.OPEN_PARENTHESIS.label, None),
            LexerOutput(1, 6, Identifier.IDENTIFIER.label, 'p'),
            LexerOutput(1, 8, Symbol.CLOSE_PARENTHESIS.label, None),
            LexerOutput(1, 10, Symbol.OPEN_BRACE.label, None),
            # line 2 - comment
            # line 3
            LexerOutput(3, 4, Keyword.PRINT_STRING.label, None),
            LexerOutput(3, 10, Symbol.OPEN_PARENTHESIS.label, None),
            LexerOutput(3, 12, Identifier.IDENTIFIER.label, 'n'),
            LexerOutput(3, 14, Symbol.COMMA.label, None),
            LexerOutput(3, 16, Literal.STR.label, '" "'),
            LexerOutput(3, 20, Symbol.CLOSE_PARENTHESIS.label, None),
            ...
            # line 5
            LexerOutput(5, 1, Symbol.CLOSE_BRACE.label, None),
            # line 6
    ...
    def test_without_whitespace(self):
        ...
        self.thenReturnLexerOutput([
            LexerOutput(1, 1, Keyword.IF.label, None),
            LexerOutput(1, 3, Symbol.OPEN_PARENTHESIS.label, None),
            LexerOutput(1, 4, Identifier.IDENTIFIER.label, 'p'),
            LexerOutput(1, 5, Symbol.CLOSE_PARENTHESIS.label, None),
            LexerOutput(1, 6, Symbol.OPEN_BRACE.label, None),
            LexerOutput(1, 7, Keyword.PRINT_STRING.label, None),
            LexerOutput(1, 12, Symbol.OPEN_PARENTHESIS.label, None),
            LexerOutput(1, 13, Identifier.IDENTIFIER.label, 'n'),
            LexerOutput(1, 14, Symbol.COMMA.label, None),
            LexerOutput(1, 15, Literal.STR.label, '" "'),
            LexerOutput(1, 18, Symbol.CLOSE_PARENTHESIS.label, None),
            ...
            LexerOutput(1, 34, Symbol.CLOSE_BRACE.label, None),
    ...
    def test_case_1_without_multiline_comment(self):
        ...
        self.thenReturnLexerOutput([
            ...
            LexerOutput(1, 6, Symbol.OPEN_PARENTHESIS.label, None),
            LexerOutput(1, 7, Literal.STR.label, '"Hello, World!\\n"'),
            LexerOutput(1, 24, Symbol.CLOSE_PARENTHESIS.label, None),
    ...
    def test_case_phoenix_number_without_multiline_comment(self):
        ...
        self.thenReturnLexerOutput([
            ...
            LexerOutput(2, 6, Symbol.OPEN_PARENTHESIS.label, None),
            ...
            LexerOutput(2, 27, Symbol.CLOSE_PARENTHESIS.label, None),
    ...
    def test_case_count(self):
        ...
        self.thenReturnLexerOutput([
            ...
            LexerOutput(2, 7, Symbol.OPEN_PARENTHESIS.label, None),
            ...
            LexerOutput(2, 18, Symbol.CLOSE_PARENTHESIS.label, None),
            LexerOutput(2, 20, Symbol.OPEN_BRACE.label, None),
            # line 3
            ...
            LexerOutput(3, 36, Symbol.CLOSE_PARENTHESIS.label, None),
